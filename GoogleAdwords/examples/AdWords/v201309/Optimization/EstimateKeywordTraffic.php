...
try {
  ...
  /*
  Client ID 410637168219-8jjbillguhrba23r10dn6orc98kgo5t1.apps.googleusercontent.com
 Email address 410637168219-8jjbillguhrba23r10dn6orc98kgo5t1@developer.gserviceaccount.com
 Client secret bepGLVhNz_i7mRxUVkJbXZSD
 Redirect URIs 
http://keywordtrack.net/adwords
 Javascript Origins 
http://keywordtrack.net
[4/8/2014 8:02:30 PM] Coded Design, Inc.: Developer Token: VQZgOLzlPPFrEcuc_DPIcA
  */
  
  $USER="410637168219-8jjbillguhrba23r10dn6orc98kgo5t1@developer.gserviceaccount.com";
  $PASS="bepGLVhNz_i7mRxUVkJbXZSD";
  $CLIENTID="410637168219-8jjbillguhrba23r10dn6orc98kgo5t1.apps.googleusercontent.com";
  $USERAGENT="";
  $DEVTOKEN="VQZgOLzlPPFrEcuc_DPIcA";
  //$USE_SANDBOX="";
  /*$authenticationIniPath = NULL, $email = NULL,
  ...
  $user = new AdWordsUser($authenticationIniPath = NULL, $email = $USER,
      $password = $PASS, $developerToken = $DEVTOKEN, $applicationToken = NULL,
      $userAgent = NULL, $clientCustomerId = $CLIENTID, $settingsIniPath = NULL,
      $authToken = NULL, $oauth2Info = NULL
	    ) ;
