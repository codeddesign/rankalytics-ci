...
<div class="bodywrapper">
	<div class="ranktracker-bottomwhitetitle"><?= lang('about.whitetitle');?></div>
	<div class="ranktracker-bottomwhitewrapper">
		<div class="ranktracker-bottomwhitesubcontent" style="margin-bottom:70px;text-align:left;"><?= lang('about.whitecont');?></div>

	</div>
	<div class="homefeatures-smallline"></div>
	<div class="checkoutfeatures"><?= lang('about.checkout');?></div>
