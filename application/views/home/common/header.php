...
<li <?php echo ($current=="reports"? 'class="active"':''); ?>><a href="<?php echo base_url();?>reports">Reports</a></li>
<li <?php echo ($current=="dashboard"? 'class="active"':''); ?>><a href="<?php echo base_url();?>dashboard">Dashboard</a></li>
		</ul>
	</div>
