//load csv data
d3.csv(playerform+"graph_odesk_csv_data.csv", ready);

//set options
var options = {
  width: 900, //page width
  ...
  rows: ["Rankings", "ERT", "KEI", "SEO Visibility"],
  ...
  rowFormats: [d3.format(",.0f"), d3.format(",.0f"), d3.format(",.0f"), d3.format(".0%")],
  rowColors: ["#029dc8", "#e87777", "#fea501", "#a169a6"], //colors for the rows defined above
  toolColor: "#02A7CF", //color of tooltip element
...
ui.append("img").attr("id", "dateImg").attr("src", playerform+"calendar.jpg");
  ...
  function drawTool(d) {
    ...
    tooltip.selectAll("div.toolGroup")
        .each(function(d) {
          ...
          me.select(".topLeft").text(options.rowFormats[myIndex](myData[d]));
