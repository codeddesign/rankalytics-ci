 ...
 * 
 * @author  Ignacio Soriano Cano y Pablo SÃ¡nchez Lozano
 * @version 1.0.0
 */
class Paymill {
	...
	function authentication($service)
	{
        ...
        switch ($service) {
            ...
            case self::TRANSACTIONS:
                ...
                break;
            case self::TRANSACTIONS:
                return new Services_Paymill_Webhooks($apiKey, $apiEndpoint);
                break;
            default:
                return new Services_Paymill_Clients($apiKey, $apiEndpoint);
                break;
...
$webhook->setUrl('<your-webhook-url>')
        ->setEventTypes(array(
            ...
            $webhooksObject = $this->authentication(self::WEBHOOKS);
	 ...
	 * if youâ€™re providing the client-property, the payment
	 ...
	 * if youâ€™re providing the client-property, the payment will 
	 ...
	 * was refunded in parts or wasnâ€™t refunded at all. The inserted
	 ...
	 * All other attributes that shouldnâ€™t be edited arenâ€™t inserted.
	 *
	 * @param  string, client id
	 * @param  string, email *optional
	 * @param  string, description *optional
	...
	/**
	 * Deletes a client, but your transactions arenâ€™t deleted.
	 * 
	 * @param  string, client id
	 * @return array, client data
	 */
     ...
     * @param   int, amount *optional
     * @param   Â¿?, created_at *optional
     * @param   Â¿?, trial_period_days *optional
	 ...
	 * @return array, subscription data
	 */
	function update_subscription($id, $offer,$payment ,$cancel_at_period_end)
	{
		$params = array(
		    'id'					=>	$id,
                    'offer'		=>	$offer,
